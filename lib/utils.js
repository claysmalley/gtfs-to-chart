...
const getStationsFromTrip = async trip => {
  ...
  return trip.stoptimes.map((stoptime, index) => {
    ...
    const amtrakStation = find(amtrakStations, ['stop_id', stop.stop_id]);
    ...
    return {
      ...
      stop_short_name: amtrakStation.stop_short_name,
      state: amtrakStation.state,
      major: amtrakStation.major,
    };
  });
};
